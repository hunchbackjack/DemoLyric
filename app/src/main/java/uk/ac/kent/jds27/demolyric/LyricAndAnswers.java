...
class LyricAndAnswers {
    ...
    LyricAndAnswers() {
        ...
        lyrics.add("But not us, (no never) no not us (no never) we are far too young and clever" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Come On Eileen - Dexys Midnight Runners");
        ...
        lyrics.add("Watching the people get lairy, it's not very pretty I tell thee. Walking through town is quite scary, it's not very sensible either" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "I Predict A Riot - Kaiser Chiefs");
        lyrics.add("There is nothing I need except the function to breathe, but I'm not really fussed, doesn't matter to me" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Ruby - Kaiser Chiefs");
        lyrics.add("So one, two, three, take my hand and come with me because you look so fine that I really wanna make you mine" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Are You Gonna Be My Girl - Jet");
        lyrics.add("I wanted the fame but not the cover of Newsweek, oh well, guess beggars can't be choosey" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "The Monster - Eminem");
        lyrics.add("Jack had a gang that he called 'The Many Grams', he was known as Smack Jack the Cracker Man" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Sheila - Jamie T");
        lyrics.add("When there's no one left to fight, boys like him don't shine so bright. Soon as I see the dust settle he's out on the town trying to find trouble" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Sticks 'n' Stones - Jamie T");
        lyrics.add("These girls are really sleazy, all they just say is please me, or spend some time and rock a rhyme, I said 'It's not that easy'" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "It's Tricky - Run D.M.C");
        lyrics.add("And I want these words to make things right, but it's the wrongs that make the words come to life. Who does he think he is?" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Thnks Fr Th Mmrs - Fall Out Boy");
        lyrics.add("Rate yourself and rake yourself, take all the courage you have left wasted on fixing all the problems that you made in your own head" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Little Lion Man - Mumford & Sons");
        lyrics.add("So break my step and relent, you forgave and I won't forget" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "I Will Wait - Mumford & Sons");
        lyrics.add("Cause I'm a sad sad post teen could have been a love machine" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Zombie - Jamie T");
        lyrics.add("Oh, let's just get this whole thing straight, I don't wanna kidnap the truth and negotiate" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Before I Fall To Pieces - Razorlight");
        lyrics.add("It's not about your make-up, or how you try to shape up to these tiresome paper dreams, paper dreams honey" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "She Moves In Her Own Way - The Kooks");
        lyrics.add("I said tell me your name is it sweet? She said my boy it's Dagger" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Chelsea Dagger - The Fratellis");
        lyrics.add("Now can I kick it, thank you, yeah I’m so damn grateful. I grew up, really wanted gold fronts but that’s what you get when Wu-Tang raised you" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Can't Hold Us - Macklemore");
        lyrics.add("Send in your skeletons, sing as their bones go marching in, again" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "The Pretender - Foo Fighters");
        lyrics.add("I won't stay put, give me the chance to be free Suffolk sadly seems to sort of suffocate me" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "You Need Me, I Don't Need You - Ed Sheeran");
        lyrics.add("I backed my car into a cop car the other day, well, he just drove off - sometimes life's okay" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Float On - Modest Mouse");
        lyrics.add("Joey was an artist just living out of case, but his best work was his letters home" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "L.I.F.E.G.O.E.S.O.N - Noah And The Whale");
        lyrics.add("We've come too far to give up who we are, so let's raise the bar and our cups to the stars" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Get Lucky - Daft Punk");
        lyrics.add("I know that I’m rich enough for pride, I see a billion dollars in your eyes. Even if we’re strangers til we die" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Runaway (U And I) - Galantis");
        lyrics.add("But if you close your eyes, does it almost feel like nothing changed at all?" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Pompeii - Bastille");
        lyrics.add("And I know she'll be the death of me, at least we'll both be numb. And she'll always get the best of me, the worst is yet to come" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Can't Feel My Face - The Weeknd");
        lyrics.add("Come on, come on, turn the radio on, it's Saturday and I won't be long. Gotta paint my nails, put my high heels on" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Cheap Thrills - Sia");
        lyrics.add("Love forever, love has freely turned forever you and me. Windmill, windmill for the land, is everybody in?" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Feel Good Inc - Gorillaz");
        lyrics.add("Let's get lost tonight, you could be my black Kate Moss tonight. Play secretary, I'm the boss tonight" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Stronger - Kanye West");
        lyrics.add("She's been living in her white bread world as long as anyone with hot blood can and now she's looking for a downtown man, that's what I am" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Uptown Girl - Billy Joel");
        lyrics.add("I know I don't know you, but I'd like to skip the small talk and romance, girl" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Can We Dance - The Vamps");
        lyrics.add("Everybody wants to know her name, how does she cope with her new found fame?" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Five Colours In Her Hair - McFly");
        lyrics.add("Her name is Noel, I have a dream about her. She rings my bell, I got gym class in half an hour" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Teenage Dirtbag - Wheatus");
        lyrics.add("I'm perusing down fourth and they watching me. I do a handstand, the eagle lands on my seat, well hello" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Downtown - Macklemore");
        lyrics.add("And I'm talking to myself at night because I can't forget. Back and forth through my mind behind a cigarette" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Seven Nation Army - The White Stripes");
        lyrics.add("We bring the stars out, we bring the women and the cars and the cards out" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Pass Out - Tinie Tempah");
        lyrics.add("Now, what you hear is not a test I'm rappin' to the beat, and me, the groove, and my friends are gonna try to move your feet" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator() + "Rappers Delight - The Sugarhill Gang");
    }
